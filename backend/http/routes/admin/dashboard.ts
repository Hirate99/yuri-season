...
export const dashboardRoutes = new Hono<ApiEnvironment>()
  .get("/summary", async (context) =>
    context.json(await context.var.services.admin.pages.summary()),
  )
  .get("/overview", async (context) =>
    context.json(await context.var.services.admin.pages.overview()),
  )
  ...
  .get("/automation", async (context) =>
    context.json(await context.var.services.admin.pages.automation()),
  )
  .get("/coverage", async (context) =>
    context.json(await context.var.services.admin.pages.coverage()),
  )
