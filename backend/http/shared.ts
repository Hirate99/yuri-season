...
export type ApiEnvironment = {
  Bindings: Env;
  Variables: { services: RequestServices; principal?: AdminPrincipal };
};
...
export function validatedJson<Input, Output = Input>(
  parse: (input: unknown, context: ApiContext) => Output,
) {
...
export function validate<Target extends "json" | "query", Schema extends z.ZodType>(
  target: Target,
  schema: Schema,
) {
