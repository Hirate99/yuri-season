...
export function SeasonGlyphArt({
  season,
  className,
}: {
  season: SeasonVisualName;
  className?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <g clipPath={`url(#${clipId})`}>
        ...
        <path
          d="M64 410C166 329 225 352 322 290C410 234 477 173 594 146V229C488 257 431 304 350 353C244 417 174 405 64 496Z"
          fill="#ffffff"
          fillOpacity="0.14"
        />
      </g>
