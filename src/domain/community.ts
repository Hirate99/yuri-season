...
export const reportInput = z.object({ reason: z.string().trim().min(1, "请说明举报原因。").max(500) });
...
export const moderationInput = z.discriminatedUnion("kind", [
  z.object({ kind: z.literal("thread"), pinned: z.boolean().optional(), locked: z.boolean().optional(), hidden: z.boolean().optional() }),
