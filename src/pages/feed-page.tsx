  ...
  return (
    <div className={page}>
      <header className="grid gap-6 py-7 md:grid-cols-[1fr_minmax(320px,520px)] md:items-end md:py-9">
        ...
        <label className="relative z-10 flex h-12 items-center gap-3 border border-black/[0.06] bg-white/75 px-4 shadow-[0_14px_35px_rgba(15,23,42,0.08)] backdrop-blur-2xl focus-within:ring-2 focus-within:ring-charcoal/20">
          <Search size={17} className="text-muted" />
          <input className="min-w-0 flex-1 bg-transparent text-sm outline-none placeholder:text-muted" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="作品、人物、来源或关键词" type="search" />
        </label>
      </header>

      <div className="sticky top-[60px] z-20 -mx-2 mt-5 grid gap-3 rounded-2xl border border-black/[0.05] bg-white/85 p-2 shadow-[0_12px_32px_rgba(15,23,42,0.06)] backdrop-blur-2xl md:top-[64px] md:grid-cols-[1fr_240px]">
