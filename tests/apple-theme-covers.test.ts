...
describe("Apple Music theme-song cover preference", () => {
  ...
  test("selects only one exact title and artist match", () => {
    expect(selectExactAppleTrack({ title: "うちゅうのふしぎ", artist: "夢限大みゅーたいぷ" }, [{
      wrapperType: "track", trackId: 6798086544, trackName: "うちゅうのふしぎ",
      artistName: "夢限大みゅーたいぷ", trackViewUrl: "https://music.apple.com/jp/song/6798086544",
      artworkUrl100: "https://is1-ssl.mzstatic.com/cover.jpg",
    }])).toMatchObject({ status: "matched", track: { trackId: 6798086544 } });
    expect(selectExactAppleTrack({ title: "うちゅうのふしぎ", artist: "別の歌手" }, [{
      wrapperType: "track", trackId: 6798086544, trackName: "うちゅうのふしぎ",
      artistName: "夢限大みゅーたいぷ", trackViewUrl: "https://music.apple.com/jp/song/6798086544",
      artworkUrl100: "https://is1-ssl.mzstatic.com/cover.jpg",
  ...
  test("refuses ambiguous exact matches", () => {
    const base = {
      wrapperType: "track", trackName: "Song", artistName: "Artist",
      artworkUrl100: "https://is1-ssl.mzstatic.com/cover.jpg",
    };
    expect(selectExactAppleTrack({ title: "Song", artist: "Artist" }, [
