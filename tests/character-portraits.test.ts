...
import { characterPortraitObjectPosition, verifiedBirthdayPortrait } from "@/lib/character-portraits";

describe("verified character portraits", () => {
  test("returns the official portrait for a verified birthday", () => {
    expect(verifiedBirthdayPortrait({
      eventType: "birthday",
      verified: true,
...
describe("character portrait focal points", () => {
  test("keeps tall mobile artwork focused on the face", () => {
    expect(characterPortraitObjectPosition(
