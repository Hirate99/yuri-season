...
const catalog: CatalogResponse = {
  ...
  anime: [{
    ...
    primarySlot: { id: "slot", label: "TOKYO MX", weekday: 5, localTime: "23:30", timezone: "Asia/Tokyo", isPrimary: true, platformUrl: null },
  }],
  events: [],
...
async function renderPanel(data: CatalogResponse) {
  const router = createRouter({
    ...
    routeTree: createRootRoute({ component: () => <TodayPanel catalog={data} viewerTimeZone="America/Los_Angeles" renderedAt={data.generatedAt} /> }),
  });
  await router.load();
