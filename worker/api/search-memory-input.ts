...
const hitSchema = z.object({
  ...
  outcome: z.enum(["seen", "candidate", "published", "held", "rejected", "ignored"], "outcome 格式不正确。").default("seen"),
...
const memorySchema = z.object({
  scopeType: z.enum(["season", "anime", "person", "character", "source", "global"], "scopeType 格式不正确。"),
  scopeId: requiredText(160, "scopeId"),
  searchKind: z.enum(["registered_source", "official_news", "social", "birthday", "media", "community", "catalog"], "searchKind 格式不正确。"),
